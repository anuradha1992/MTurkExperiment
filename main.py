...
for i in range(2, 10):
    ...
    new_hit = client.create_hit(
        ...
        QualificationRequirements=[
            ...
            {
                'QualificationTypeId': '00000000000000000071', #adult content
                'Comparator': 'In',
                'LocaleValues': [
                    {
                        'Country': 'US',
    ...
    with open('./MTurkHITs4/all_hits.txt', 'a', encoding='utf8') as outfile:
    ...
    with open('./MTurkHITs4/part_'+str(part)+'.json', 'w', encoding='utf8') as outfile:
